...
Zookeeper.prototype.getBrokers = function(cb) {
  ...
  var that = this, brokerIdPath = ((config.zkPath)?config.zkPath:'') + '/brokers/ids';
...
Zookeeper.prototype.getConsumerOffsets = function(topic, group, cb) {
  ...
  var that = this, groupTopicPath = ((config.zkPath)?config.zkPath:'') + '/consumers/' + group + '/offsets/' + topic;
  var zk = new zkcli(zkOpts);
...
Zookeeper.prototype.setConsumerOffsets = function(topic, group, offsets, cb) {
  ...
  var groupTopicPath = ((config.zkPath)?config.zkPath:'') + '/consumers/' + group + '/offsets/' + topic;
  var zk = new zkcli(zkOpts);
...
Zookeeper.prototype.getPartitions = function(topic, broker, cb) {
  ...
  var topicBrokerPath =  ((config.zkPath)?config.zkPath:'') + '/brokers/topics/' + topic + '/' + broker.id;
  var zk = new zkcli(zkOpts);
